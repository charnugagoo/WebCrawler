...
<input id="search-q"
  ...
  <input id="search-submit"
         ...
         type="submit"
         value="Search"  />
<input type="hidden" name="form_build_id" id="form-e40798052c163ee676ffe40114ae3dba" value="form-e40798052c163ee676ffe40114ae3dba"  />
...
<div class="button-links">
  ...
  <div class="view">
    ...
    <div class="posted-date date-box">
      ...
      <a href="/blog/introducing-new-metadata-for-tweets">Introducing new metadata for Tweets</a>      </div>
    <div class="row even">
    <div class="posted-date date-box">
      <span class="month">Feb</span>
      <span class="day">13</span>
    </div>
      <a href="/blog/crashlytics-update">A Crashlytics update</a>      </div>
    <div class="row odd">
    <div class="posted-date date-box">
      <span class="month">Feb</span>
