...
<META NAME="keywords" CONTENT="Programming, C++, C++ code, source code, programming code, program code, source, program source, c code, c++ source code, free source code">
<META NAME="Description" CONTENT="C and C++ source code, organized into categories to help you find what you're looking for.">
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
<title>Free C/C++ Source Code - Cprogramming.com</title>
        ...
        <tr>
          <td width="100%">
            <table border="0" cellpadding="3" cellspacing="1" width="100%">
              <tr class="title">
                <td width="100%"><font class="title">
                  </font><font class="sub-title">Find C and C++ source code to help you
                  learn to program.  You can submit your own code, or you can
                  simply browse and download the code of
                  others.<br><br>Finally, you might want to check out <a href=http://www.codecogs.com>Code Cogs - An Open Source Scientific Library / Database in C++</a> for more code.<br><br></font></td>
...
GA_googleFillSlot('RunOfSite_LargeRectangle_ATF_336x280');
              ...
              <tr class="menu">
                <td width="100%"><table cellpadding="0" cellspacing="0" border="0" width=70%>
  <tr>
    <td><font face=Arial>
      <a href="http://www.cprogramming.com/cgi-bin/source/source.cgi" class="menu" target="_top"><u>Home</u></a> | 
      <a href="http://www.cprogramming.com/cgi-bin/source/source.cgi?action=Add&Category=" class="menu" target="_top"><u>Add Resource</u></a> |
      <a href="http://www.cprogramming.com/cgi-bin/source/source.cgi?action=Modify" class="menu" target="_top"><u>Modify Resource</u></a>
      </td>
  </tr>
</table>
</td>
...
<table border="0" cellpadding="4" cellspacing="1" width="100%">
  <tr>
    <td width="100%"><font class="normal"><b><a href="http://www.cprogramming.com/cgi-bin/source/source.cgi" class="normal" target="_top">Index</a> ::</b></font></td>
  </tr>
</table>
<table border="0" cellpadding="0" cellspacing="1" width="90%" class="border">
        <tr>
          <td width="100%">
            <table border="0" cellpadding="3" cellspacing="1" width="100%">
              <tr class="large-header">
                <td width="100%"><font class="large-header">Index</font></td>
              </tr>
              <tr class="body">
                <td width="100%">
                  <font class="body">
                  <p><font size="3"><b>Categories:</b></font>
                  <p>There are a total of <b>8</b> categories at this level:
                      ...
                      <td width="50%" valign="top">
                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                          ...
                          <tr>
                            ...
                            <td width="1" nowrap valign="top"><li></li></td>
                            <td width="100%">
                              <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                <tr>
                                
                                  <td><font class="body"><a href="http://www.cprogramming.com/cgi-bin/source/source.cgi?action=Category&CID=1" target="_top">Algorithms</a> (13)<br>
                                  
                                    Code demonstrating programming concepts<br>
                            ...
                            <td width="100%">
                              <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                <tr>
                                  ...
                                  <td><font class="body"><a href="http://www.cprogramming.com/cgi-bin/source/source.cgi?action=Category&CID=2" target="_top">Games</a> (12)<br>
                                  
                                    Source code for games<br>
                            ...
                            <td width="100%">
                              <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                <tr>
                                  ...
                                  <td><font class="body"><a href="http://www.cprogramming.com/cgi-bin/source/source.cgi?action=Category&CID=3" target="_top">Language Features</a> (8)<br>
                                  
                                    Source code demonstrating specific features of C or C++<br>
                            ...
                            <td width="100%">
                              <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                <tr>
                                  ...
                                  <td><font class="body"><a href="http://www.cprogramming.com/cgi-bin/source/source.cgi?action=Category&CID=4" target="_top">Sound</a> (1)<br>
                                  
                                    Source code demonstrating sound I/O<br>
                            ...
                            <td width="100%">
                              <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                <tr>
                                  ...
                                  <td><font class="body"><a href="http://www.cprogramming.com/cgi-bin/source/source.cgi?action=Category&CID=5" target="_top">Artificial Intelligence</a> (1)<br>
                                  
                                    Source code demonstrating Artificial Intelligence concepts<br>
                            ...
                            <td width="100%">
                              <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                <tr>
                                  ...
                                  <td><font class="body"><a href="http://www.cprogramming.com/cgi-bin/source/source.cgi?action=Category&CID=6" target="_top">Graphics</a> (11)<br>
                                  
                                    Source code for accessing the graphics card<br>
                            ...
                            <td width="100%">
                              <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                <tr>
                                  ...
                                  <td><font class="body"><a href="http://www.cprogramming.com/cgi-bin/source/source.cgi?action=Category&CID=7" target="_top">Projects</a> (2)<br>
                                  
                                    Source code for full programs<br>
                            ...
                            <td width="100%">
                              <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                <tr>
                                  ...
                                  <td><font class="body"><a href="http://www.cprogramming.com/cgi-bin/source/source.cgi?action=Category&CID=8" target="_top">Utilities</a> (9)<br>
                                  
                                    Source code that performs useful utility-like functions<br>
                  ...
                  <p>There are a total of <b>57</b> resources for you to browse.</font>
                </td>
              </tr>
            </table>
          </td>
