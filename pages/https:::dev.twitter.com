...
<meta name="twitter:url" content="https://dev.twitter.com/" />
<link type="text/css" rel="stylesheet" media="all" href="https://dev.twitter.com/sites/default/files/css/css_12d12f35b5919904ea5df5e8aa9da277.css" />
...
<body id="page-home" class="front not-logged-in no-sidebars">
  <div id="page">
...
<input id="search-q"
  ...
  <input id="search-submit"
         ...
         type="submit"
         value="Search"  />
<input type="hidden" name="form_build_id" id="form-e9a3fb343309c9b9784d6ef771465e56" value="form-e9a3fb343309c9b9784d6ef771465e56"  />
...
<li class="leaf last"><a href="/user/login?destination=home" title="">Sign in</a></li>
</ul>      </div>    </div>
  ...
  <div id="panel-top">
    <div class="section">
    <h2>Build with Twitter.</h2>

<div class="product-links">
  <a href="https://dev.twitter.com/docs/embedded-timelines">Embedded Timelines</a>
  <a href="https://dev.twitter.com/docs/cards">Twitter Cards</a>
  <a href="https://dev.twitter.com/docs/embedded-tweets">Embedded Tweets</a>
</div>


<div class="button-links">
  <a href="https://dev.twitter.com/docs/tweet-button">Get the Tweet Button</a>
  <a href="https://dev.twitter.com/docs/follow-button">Get the Follow Button</a>
</div>

  </div>  </div>
  <div id="panel-first">
    <div id="blog-posts" class="section">
    <h2>Recent posts from Twitter Developer Blog</h2>

  <div class="view">
    <div class="content">
    <div class="row odd first">
    <div class="posted-date date-box">
      <span class="month">Feb</span>
      <span class="day">5</span>
    </div>
      <a href="/blog/planning-for-api-v1-retirement">Planning for API v1’s Retirement</a>      </div>
    <div class="row even">
    <div class="posted-date date-box">
      <span class="month">Jan</span>
      <span class="day">22</span>
    </div>
      <a href="/blog/64-bit-twitter-user-idpocalypse">Moving to 64-bit Twitter User IDs</a>      </div>
    <div class="row odd">
    <div class="posted-date date-box">
      <span class="month">Jan</span>
      <span class="day">22</span>
    </div>
      <a href="/blog/improvements-embedded-tweets">Improvements for Embedded Tweets</a>      </div>
    <div class="row even last">
    <div class="posted-date date-box">
      <span class="month">Jan</span>
      <span class="day">17</span>
    </div>
      <a href="/blog/expanding-twitter-certified-products-program">Expanding the Twitter Certified Products Program</a>      </div>
    </div>
  </div> 
  ...
  <div id="panel-last">
    ...
    <h2>Create applications that integrate Twitter</h2>

<div>
  <a href="/docs">Get started with the platform</a>
  Explore the documentation and manage your apps
</div>

<div>
  <a href="/discussions">Discuss</a>
  Get in touch with the @twitterapi team and the community of developers
</div>

<div>
  <a href="https://dev.twitter.com/programs/twitter-certified-products">Explore Twitter Certified Products</a>
  Valuable products and services built on Twitter
</div>
