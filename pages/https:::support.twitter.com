...
<head>
  ...
  <script src="https://hca.twimg.com/a/1360279976/javascripts/shared/widget.js" type="text/javascript"></script>

  <link href="https://hca.twimg.com/a/1360279976/stylesheets/less/compiled/help_center.css" media="screen" rel="stylesheet" type="text/css" />

  <!--[if IE]>
    <link href="https://hca.twimg.com/a/1360279976/stylesheets/ie.css" media="screen" rel="stylesheet" type="text/css" />
  <![endif]-->
  <!--[if IE 7]>
    <link href="https://hca.twimg.com/a/1360279976/stylesheets/ie7.css" media="screen" rel="stylesheet" type="text/css" />
  <![endif]-->
      ...
      <div class="fixed-container clearfix">
        <div id="home-logo">
          <a class="logo" accesskey="1" href="/">
            <img alt="Twitter-bird" src="https://hca.twimg.com/a/1360279976/images/twitter-bird.png" />
...
<option value="tr">Türkçe</option></select>
        ...
        <form method="post" id="sign_out_form" action="/sessions/destroy" style="display:none;">
          <input name="authenticity_token" value="F823UnQ31poczPDJ1XWhJCmC0vfPZTxXtA+PydA4Bus=" type="hidden"/>
        </form>
      </div> <!-- /fixed-container -->
    </div> <!-- /topbar-inner -->
  </div> <!-- /topbar -->
...
<div class="row clearfix">
  ...
  <div class="five columns aside tweet-sidebar">
    <script src="https://hca.twimg.com/a/1360279976/javascripts/lib/twt/twt.min.js" type="text/javascript"></script>
<link href="https://hca.twimg.com/a/1360279976/stylesheets/twt.css" media="screen" rel="stylesheet" type="text/css" />
<link href="https://hca.twimg.com/a/1360279976/stylesheets/less/compiled/profile_timeline.css" media="screen" rel="stylesheet" type="text/css" />
...
<script src="https://hca.twimg.com/a/1360279976/javascripts/shared/google_analytics.js" type="text/javascript"></script>

<script data-main="https://hca.twimg.com/a/1360279976/javascripts/bundled/pages/common_with_tweets.js" data-path="https://hca.twimg.com/a/1360279976/javascripts/" src="https://hca.twimg.com/a/1360279976/javascripts/lib/hclr.min.js" type="text/javascript"></script>
